from queen_functions import Queen
...
# Indicates if no queen can attack each other
...
# Indicates if the solution has been found and the number of queens.
def is_soluce(board_size, board):
    ...
    is_a_soluce = (True
                   if (can_t_attack(board_size, board)
                       and nb_queens == board_size)
                   else False)
